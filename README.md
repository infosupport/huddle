...
### Docker Socket Proxy
- Every devcontainer gets its own Unix socket at `/tmp/dc-sockets/<name>.sock`
- Access is limited by a time-bound grant (1–120 minutes)
...
- Grants survive a Huddle restart; proxy sockets are recreated on restart
